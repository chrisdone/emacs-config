...
(define-key flycheck-error-list-mode-map (kbd "C--") 'flycheck-less)
(define-key flycheck-error-list-mode-map (kbd "-") 'flycheck-less)
(defun flycheck-more ()
  (interactive)
  (setf flycheck-lines (+ 1 flycheck-lines))
  (flycheck-error-list-refresh))
(defun flycheck-less ()
  (interactive)
  (setf flycheck-lines (+ flycheck-lines -1))
  (flycheck-error-list-refresh))
