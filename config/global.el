...
(define-key global-map [?\M-1] '(lambda () (interactive) (elscreen-goto 0)))
(define-key global-map [?\M-2] '(lambda () (interactive) (elscreen-goto 1)))
(define-key global-map [?\M-3 ] '(lambda () (interactive) (elscreen-goto 2)))
(define-key global-map [?\M-4] '(lambda () (interactive) (elscreen-goto 3)))
(define-key global-map [?\M-5] '(lambda () (interactive) (elscreen-goto 4)))
(define-key global-map [?\M-6] '(lambda () (interactive) (elscreen-goto 5)))
(define-key global-map [?\M-7] '(lambda () (interactive) (elscreen-goto 6)))
(define-key global-map [?\M-8] '(lambda () (interactive) (elscreen-goto 7)))
(define-key global-map [?\M-9] '(lambda () (interactive) (elscreen-goto 8)))

(define-key magit-mode-map [?\M-1] '(lambda () (interactive) (elscreen-goto 0)))
(define-key magit-mode-map [?\M-2] '(lambda () (interactive) (elscreen-goto 1)))
(define-key magit-mode-map [?\M-3 ] '(lambda () (interactive) (elscreen-goto 2)))
(define-key magit-mode-map [?\M-4] '(lambda () (interactive) (elscreen-goto 3)))
(define-key magit-mode-map [?\M-5] '(lambda () (interactive) (elscreen-goto 4)))
(define-key magit-mode-map [?\M-6] '(lambda () (interactive) (elscreen-goto 5)))
(define-key magit-mode-map [?\M-7] '(lambda () (interactive) (elscreen-goto 6)))
(define-key magit-mode-map [?\M-8] '(lambda () (interactive) (elscreen-goto 7)))
(define-key magit-mode-map [?\M-9] '(lambda () (interactive) (elscreen-goto 8)))
